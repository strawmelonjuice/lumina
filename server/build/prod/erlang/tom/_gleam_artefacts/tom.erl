...
-spec push_key({ok, WMA} | {error, get_error()}, binary()) -> {ok, WMA} |
    {error, get_error()}.
push_key(Result, Key) ->
    case Result of
        {ok, T} ->
...
-spec expect_end_of_line(
    list(binary()),
    fun((list(binary())) -> {ok, {WOF, list(binary())}} | {error, parse_error()})
) -> {ok, {WOF, list(binary())}} | {error, parse_error()}.
...
-spec do(
    {ok, {WOQ, list(binary())}} | {error, parse_error()},
    fun((WOQ, list(binary())) -> {ok, WOT} | {error, parse_error()})
) -> {ok, WOT} | {error, parse_error()}.
do(Result, Next) ->
    case Result of
        {ok, {A, Input}} ->
            Next(A, Input);
...
-spec expect(
    list(binary()),
    binary(),
    fun((list(binary())) -> {ok, {WOY, list(binary())}} | {error, parse_error()})
) -> {ok, {WOY, list(binary())}} | {error, parse_error()}.
