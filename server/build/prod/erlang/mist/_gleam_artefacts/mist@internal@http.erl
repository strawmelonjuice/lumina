...
?DOC(false).
-spec add_date_header(gleam@http@response:response(SUS)) -> gleam@http@response:response(SUS).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(SUV)) -> gleam@http@response:response(SUV).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(SUY)) -> gleam@http@response:response(SUY).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(SVB)) -> gleam@http@response:response(SVB).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(SVG)) -> gleam@http@response:response(SVG)).
