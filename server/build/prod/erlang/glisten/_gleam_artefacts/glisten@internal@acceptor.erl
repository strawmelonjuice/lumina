...
-type pool(LVD, LVE) :: {pool,
        fun((LVD, glisten@internal@handler:loop_message(LVE), glisten@internal@handler:connection(LVE)) -> glisten@internal@handler:next(LVD, glisten@internal@handler:loop_message(LVE))),
        integer(),
        gleam@erlang@process:name(gleam@otp@factory_supervisor:message(glisten@socket:socket(), gleam@erlang@process:subject(glisten@internal@handler:message(LVE)))),
        fun((glisten@internal@handler:connection(LVE)) -> {LVD,
            gleam@option:option(gleam@erlang@process:selector(LVE))}),
        gleam@option:option(fun((LVD) -> nil)),
        glisten@transport:transport(),
...
-spec start(
    ...
    gleam@erlang@process:name(gleam@otp@factory_supervisor:message(glisten@socket:socket(), gleam@erlang@process:subject(glisten@internal@handler:message(LVG))))
) -> {ok,
