...
?DOC(false).
-spec add_date_header(gleam@http@response:response(TFS)) -> gleam@http@response:response(TFS).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(TFV)) -> gleam@http@response:response(TFV).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(TFY)) -> gleam@http@response:response(TFY).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(TGB)) -> gleam@http@response:response(TGB).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(TGG)) -> gleam@http@response:response(TGG)).
