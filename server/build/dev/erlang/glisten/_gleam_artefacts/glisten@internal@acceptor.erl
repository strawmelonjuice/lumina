...
-type pool(LVW, LVX) :: {pool,
        fun((LVW, glisten@internal@handler:loop_message(LVX), glisten@internal@handler:connection(LVX)) -> glisten@internal@handler:next(LVW, glisten@internal@handler:loop_message(LVX))),
        integer(),
        gleam@erlang@process:name(gleam@otp@factory_supervisor:message(glisten@socket:socket(), gleam@erlang@process:subject(glisten@internal@handler:message(LVX)))),
        fun((glisten@internal@handler:connection(LVX)) -> {LVW,
            gleam@option:option(gleam@erlang@process:selector(LVX))}),
        gleam@option:option(fun((LVW) -> nil)),
        glisten@transport:transport(),
...
-spec start(
    ...
    gleam@erlang@process:name(gleam@otp@factory_supervisor:message(glisten@socket:socket(), gleam@erlang@process:subject(glisten@internal@handler:message(LVZ))))
) -> {ok,
