...
prepare-build:
	...
	[ ! -f ./lumina/web/initialiser/build/oat.min.js ] && curl https://unpkg.com/@knadh/oat@{{ oat_version }}/oat.min.js -o ./lumina/web/initialiser/build/oat.min.js || echo "No download."
	[ ! -f ./lumina/web/initialiser/build/oat.min.css ] && curl https://unpkg.com/@knadh/oat@{{ oat_version }}/oat.min.css -o ./lumina/web/initialiser/build/oat.min.css || echo "No download."
	...
	cat ./lumina/web/initialiser/build/oat.min.js >> ./lumina/web/initialiser/build/dev/javascript/lumina_spa/oat.mjs
	...
	echo -en "\n\n/* Oat.css {{ oat_version }} */\n" >> "./lumina/backend/priv/lumina.css"
	cat ./lumina/web/initialiser/build/oat.min.css >> "./lumina/backend/priv/lumina.css"
	# And Lumina's own.
	echo -en "\n\n/* Lumina's own styles */\n" >> "./lumina/backend/priv/lumina.css"
